...
public class ServletWebServerApplicationContext extends GenericWebApplicationContext
	...
	/** description: 启动tomcat容器,然后加载一些初始化对象的方法
	 * 1. 获取一个 WebServer 即tomcat容器
	 * 2. 获取 ServletContext 服务的上下文
	 * 3. 获取一个 ServletWebServer 的工厂类
	 * 4. 初始化一个tomcat对象, 这个方法会创建一个Web容器,例如使用Tomcat容器,则默认创建的是一个Tomcat
	 ...
	 * 5. registerSingleton() 注册单例的一些bean
	 * 6. initPropertySources这里进行初始化
	 * 		1). getEnvironment 获取配置文件的一些信息
	 * @param
	 * @return: void
	 * @Author: zeryts
